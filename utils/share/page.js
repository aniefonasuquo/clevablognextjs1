...
function SocialSharing({title}) {
  ...
  return (
    <div className={styles.socialsharing}>
      <div onClick={shareOnTwitter} className={styles.facebook}>
      ...
      <div onClick={shareOnLinkedIn} className={styles.facebook}>
      ...
      <div onClick={shareOnFacebook} className={styles.facebook}>
      ...
      <div onClick={shareOnWhatsapp} className={styles.facebook}>
      ...
      <div onClick={shareOnTelegram} className={styles.facebook}>
